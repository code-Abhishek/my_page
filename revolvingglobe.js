...
// const globeTexture = textureLoader.load('path_to_your_globe_texture.jpg'); // Replace with your texture path
...
const MASK_IMAGE = "./assets/text.png";

const SPHERE_RADIUS = 30;
const LATITUDE_COUNT = 80;
const DOT_DENSITY = 0.8;
const INITIAL_ROTATION = 1.7;
...
const renderScene = (imageData) => {
  ...
  const animate = (time) => {
    ...
    dotMesh.rotation.y = time * -0.1 + INITIAL_ROTATION;
